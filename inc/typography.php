...
if ( ! function_exists( 'wi_enqueue_google_fonts' ) ) {
	add_action( 'wp_enqueue_scripts', 'wi_enqueue_google_fonts', 0 );
	/**
	...
	function wi_enqueue_google_fonts() {
		...
		$not_google = str_replace( ' ', '+', wi_typography_default_fonts() );
		...
		if ( ! empty( $font_settings ) ) {
			...
			foreach ( $font_settings as $key ) {
				...
				if ( ! isset( $wi_settings[ $key ] ) ) {
					continue;
				}

				// If our value is still using the old format, fix it.
				if ( strpos( $wi_settings[ $key ], ':' ) !== false ) {
					$wi_settings[ $key ] = current( explode( ':', $wi_settings[ $key ] ) );
				}

				$value = str_replace( ' ', '+', $wi_settings[ $key ] );

				$variants = wi_get_google_font_variants( $wi_settings[ $key ], $key );
		...
		$google_fonts = apply_filters( 'wi_typography_google_fonts', $google_fonts );

		$subset = apply_filters( 'wi_fonts_subset', '' );
		...
		$display = apply_filters( 'wi_google_font_display', '' );
		...
		if ( $google_fonts ) {
			wp_enqueue_style( 'wi-fonts', $fonts_url, array(), null, 'all' ); // phpcs:ignore
		}
	}
}

if ( ! function_exists( 'wi_default_fonts_customize_register' ) ) {
	add_action( 'customize_register', 'wi_default_fonts_customize_register' );
	/**
	 ...
	 */
	function wi_default_fonts_customize_register( $wp_customize ) {
		if ( wi_is_using_dynamic_typography() ) {
			return;
		}

		if ( function_exists( 'wi_fonts_customize_register' ) ) {
		...
		$defaults = wi_get_default_fonts();

		if ( method_exists( $wp_customize, 'register_control_type' ) ) {
			$wp_customize->register_control_type( 'wi_Typography_Customize_Control' );
		...
		$wp_customize->add_setting(
			...
			array(
				...
				'sanitize_callback' => 'wi_sanitize_variants',
			)
		);

		$wp_customize->add_setting(
			'wi_settings[body_font_weight]',
			array(
		...
		$wp_customize->add_setting(
			'wi_settings[body_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new wi_Typography_Customize_Control(
				$wp_customize,
				'body_typography',
				array(
					'label' => __( 'Body', 'witheme' ),
					'section' => 'font_section',
					'priority' => 1,
					'settings' => array(
						'family' => 'wi_settings[font_body]',
						'variant' => 'font_body_variants',
						'category' => 'font_body_category',
						'weight' => 'wi_settings[body_font_weight]',
						'transform' => 'wi_settings[body_font_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'description' => __( 'Font size', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[body_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		$wp_customize->add_setting(
			'wi_settings[body_line_height]',
			array(
				'default' => $defaults['body_line_height'],
				'type' => 'option',
				'sanitize_callback' => 'wi_sanitize_decimal_integer',
				'transport' => 'postMessage',
			)
		);
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					'type' => 'witheme-range-slider',
					'description' => __( 'Line height', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[body_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 1,
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					'type' => 'witheme-range-slider',
					'description' => __( 'Paragraph margin', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[paragraph_margin]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_1_transform]',
			array(
		...
		$wp_customize->add_control(
			new wi_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 1 (H1)', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'wi_settings[font_heading_1]',
						'variant' => 'font_heading_1_variants',
						'category' => 'font_heading_1_category',
						'weight' => 'wi_settings[heading_1_weight]',
						'transform' => 'wi_settings[heading_1_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'wi_settings[heading_1_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'wi_settings[mobile_heading_1_font_size]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_1_font_size]',
						'mobile' => 'wi_settings[mobile_heading_1_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_1_line_height]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_1_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_2_transform]',
			array(
		...
		$wp_customize->add_control(
			new wi_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 2 (H2)', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'wi_settings[font_heading_2]',
						'variant' => 'font_heading_2_variants',
						'category' => 'font_heading_2_category',
						'weight' => 'wi_settings[heading_2_weight]',
						'transform' => 'wi_settings[heading_2_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'wi_settings[heading_2_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'wi_settings[mobile_heading_2_font_size]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_2_font_size]',
						'mobile' => 'wi_settings[mobile_heading_2_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_2_line_height]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_2_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_3_transform]',
			array(
		...
		$wp_customize->add_control(
			new wi_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 3 (H3)', 'witheme' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'wi_settings[font_heading_3]',
						'variant' => 'font_heading_3_variants',
						'category' => 'font_heading_3_category',
						'weight' => 'wi_settings[heading_3_weight]',
						'transform' => 'wi_settings[heading_3_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'wi_settings[heading_3_font_size]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_3_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		$wp_customize->add_setting(
			'wi_settings[heading_3_line_height]',
			array(
		...
		$wp_customize->add_control(
			new wi_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'wi_settings[heading_3_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		if ( ! function_exists( 'wi_fonts_customize_register' ) && ! defined( 'GP_PREMIUM_VERSION' ) ) {
			$wp_customize->add_control(
				new wi_Customize_Misc_Control(
					...
					array(
						...
						'description' => __( 'More options are available for this section in our premium version.', 'witheme' ),
...
if ( ! function_exists( 'wi_get_all_google_fonts' ) ) {
	/**
	 ...
	 */
	function wi_get_all_google_fonts( $amount = 'all' ) {
		...
		if ( apply_filters( 'wi_alphabetize_google_fonts', true ) ) {
			asort( $fonts );
		}

		return apply_filters( 'wi_google_fonts_array', $fonts );
	}
}

if ( ! function_exists( 'wi_get_all_google_fonts_ajax' ) ) {
	add_action( 'wp_ajax_wi_get_all_google_fonts_ajax', 'wi_get_all_google_fonts_ajax' );
	/**
	 * Return an array of all of our Google Fonts.
	 *
	 * @since 1.3.0
...
if ( ! function_exists( 'wi_get_google_font_variants' ) ) {
	/**
	 ...
	 */
	function wi_get_google_font_variants( $font, $key = '' ) {
		// Don't need variants if we're using a system font.
		if ( in_array( $font, wi_typography_default_fonts() ) ) {
			return;
		}
		...
		if ( $variants ) {
			...
			return implode( ',', apply_filters( 'wi_typography_variants', $output ) );
		}
	}
}

if ( ! function_exists( 'wi_get_google_font_category' ) ) {
	/**
	 ...
	 */
	function wi_get_google_font_category( $font, $key = '' ) {
...
if ( ! function_exists( 'wi_get_font_family_css' ) ) {
	/**
	 ...
	 */
	function wi_get_font_family_css( $font, $settings, $default ) {
		$wi_settings = wp_parse_args(
		...
		$no_quotes = array(
			...
			apply_filters( 'wi_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' ),
		);

		$font_family = $wi_settings[ $font ];

		if ( 'System Stack' === $font_family ) {
			$font_family = apply_filters( 'wi_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' );
		}
		...
		if ( in_array( $font_family, $no_quotes ) ) {
			...
			$wrapper_start = '"';
			$wrapper_end = '"' . wi_get_google_font_category( $font_family, $font );
		}
...
if ( ! function_exists( 'wi_add_to_font_customizer_list' ) ) {
	add_filter( 'wi_typography_customize_list', 'wi_add_to_font_customizer_list' );
	/**
	 ...
	 */
	function wi_add_to_font_customizer_list( $fonts ) {
		// Bail if we don't have our defaults.
		if ( ! function_exists( 'wi_get_default_fonts' ) ) {
			return;
		}
		...
		$all_fonts = wi_get_all_google_fonts();
		$select_fonts = wi_get_all_google_fonts( apply_filters( 'wi_number_of_fonts', 200 ) );

		foreach ( $font_settings as $setting ) {
			// If we don't have a setting, keep going.
			if ( ! isset( $wi_settings[ $setting ] ) ) {
				continue;
			}

			$id = strtolower( str_replace( ' ', '_', $wi_settings[ $setting ] ) );

			if ( array_key_exists( $id, $select_fonts ) || in_array( $wi_settings[ $setting ], wi_typography_default_fonts() ) ) {
				continue;
			}

			$fonts[ strtolower( str_replace( ' ', '_', $wi_settings[ $setting ] ) ) ] = array(
				'name' => $wi_settings[ $setting ],
		...
		if ( function_exists( 'wi_secondary_nav_get_defaults' ) ) {
			...
			if ( ! array_key_exists( $secondary_nav_id, $select_fonts ) && ! in_array( $secondary_nav_settings['font_secondary_navigation'], wi_typography_default_fonts() ) ) {
...
if ( ! function_exists( 'wi_typography_set_font_data' ) ) {
	add_action( 'admin_init', 'wi_typography_set_font_data' );
	/**
	 ...
	 * @since 1.3.40
	 */
	function wi_typography_set_font_data() {
		if ( wi_is_using_dynamic_typography() ) {
			return;
		}
		...
		if ( $defaults['font_body'] == $wi_settings['font_body'] ) { // phpcs:ignore
			return;
		}

		// Don't need to continue if we're using a system font or our default font.
		if ( in_array( $wi_settings['font_body'], wi_typography_default_fonts() ) ) {
			return;
		}
		...
		// Get the ID from our font.
		$id = strtolower( str_replace( ' ', '_', $wi_settings['font_body'] ) );
