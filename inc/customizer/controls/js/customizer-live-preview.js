 ...
 * @param get_value
 */
function witheme_colors_live_update( id, selector, property, default_value, get_value ) {
	default_value = typeof default_value !== 'undefined' ? default_value : 'initial';
	get_value = typeof get_value !== 'undefined' ? get_value : '';

	wp.customize( 'wi_settings[' + id + ']', function( value ) {
		value.bind( function( newval ) {
			default_value = ( '' !== get_value ) ? wp.customize.value( 'wi_settings[' + get_value + ']' )() : default_value;
...
function witheme_classes_live_update( id, classes, selector, prefix ) {
...
function witheme_typography_live_update( id, selector, property, unit, media, settings ) {
	settings = typeof settings !== 'undefined' ? settings : 'wi_settings';
	wp.customize( settings + '[' + id + ']', function( value ) {
		value.bind( function( newval ) {
			...
			if ( 'buttons_font_size' == id && '' == wp.customize( 'wi_settings[buttons_font_size]' ).get() ) {
				newval = wp.customize( 'wi_settings[body_font_size]' ).get();
			}
			...
			if ( ! isTablet && ! isMobile ) {
				...
				if ( '' !== tabletValue && '' == mobileValue ) {
					media = witheme_live_preview.desktop + ', ' + witheme_live_preview.mobile;
				}

				// The tablet setting doesn't exist, mobile does
				if ( '' == tabletValue && '' !== mobileValue ) {
					media = witheme_live_preview.desktop + ', ' + witheme_live_preview.tablet;
				}

				// The tablet setting doesn't exist, neither does mobile
				if ( '' == tabletValue && '' == mobileValue ) {
					media = witheme_live_preview.desktop + ', ' + witheme_live_preview.tablet + ', ' + witheme_live_preview.mobile;
				}
			}
			...
			setTimeout( "jQuery('body').trigger('wi_spacing_updated');", 1000 );
		} );
	} );
}
...
( function( $ ) {
	...
	wp.customize( 'wi_settings[logo_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Container width
	 */
	wp.customize( 'wi_settings[container_width]', function( value ) {
		value.bind( function( newval ) {
			...
			jQuery( 'body' ).trigger( 'wi_spacing_updated' );
		} );
	} );
	...
	if ( 'undefined' === typeof gp_premium_typography_live_update ) {
		 ...
		 */
		witheme_typography_live_update( 'body_font_size', 'body, button, input, select, textarea', 'font-size', 'px' );
		witheme_typography_live_update( 'body_line_height', 'body', 'line-height', '' );
		witheme_typography_live_update( 'paragraph_margin', 'p, .entry-content > [class*="wp-block-"]:not(:last-child)', 'margin-bottom', 'em' );
		witheme_typography_live_update( 'body_font_weight', 'body, button, input, select, textarea', 'font-weight' );
		witheme_typography_live_update( 'body_font_transform', 'body, button, input, select, textarea', 'text-transform' );

		/**
		 * H1 font size, weight and transform
		 */
		witheme_typography_live_update( 'heading_1_font_size', 'h1', 'font-size', 'px', witheme_live_preview.desktop );
		witheme_typography_live_update( 'mobile_heading_1_font_size', 'h1', 'font-size', 'px', witheme_live_preview.mobile );
		witheme_typography_live_update( 'heading_1_weight', 'h1', 'font-weight' );
		witheme_typography_live_update( 'heading_1_transform', 'h1', 'text-transform' );
		witheme_typography_live_update( 'heading_1_line_height', 'h1', 'line-height', 'em' );

		/**
		 * H2 font size, weight and transform
		 */
		witheme_typography_live_update( 'heading_2_font_size', 'h2', 'font-size', 'px', witheme_live_preview.desktop );
		witheme_typography_live_update( 'mobile_heading_2_font_size', 'h2', 'font-size', 'px', witheme_live_preview.mobile );
		witheme_typography_live_update( 'heading_2_weight', 'h2', 'font-weight' );
		witheme_typography_live_update( 'heading_2_transform', 'h2', 'text-transform' );
		witheme_typography_live_update( 'heading_2_line_height', 'h2', 'line-height', 'em' );

		/**
		 * H3 font size, weight and transform
		 */
		witheme_typography_live_update( 'heading_3_font_size', 'h3', 'font-size', 'px' );
		witheme_typography_live_update( 'heading_3_weight', 'h3', 'font-weight' );
		witheme_typography_live_update( 'heading_3_transform', 'h3', 'text-transform' );
		witheme_typography_live_update( 'heading_3_line_height', 'h3', 'line-height', 'em' );
	}

	/**
	 * Top bar width
	 */
	wp.customize( 'wi_settings[top_bar_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value( 'wi_settings[top_bar_inner_width]' )() ) {
	 ...
	 * Inner top bar width
	 */
	wp.customize( 'wi_settings[top_bar_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.inside-top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
			}
	 ...
	 * Top bar alignment
	 */
	witheme_classes_live_update( 'top_bar_alignment', [ 'left', 'center', 'right' ], '.top-bar', 'top-bar-align-' );

	/**
	 * Header layout
	 */
	wp.customize( 'wi_settings[header_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			if ( 'fluid-header' == newval ) {
				$( '.site-header' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value( 'wi_settings[header_inner_width]' )() ) {
	 ...
	 * Inner Header layout
	 */
	wp.customize( 'wi_settings[header_inner_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Header alignment
	 */
	witheme_classes_live_update( 'header_alignment_setting', [ 'left', 'center', 'right' ], 'body', 'header-aligned-' );

	/**
	 * Navigation width
	 */
	wp.customize( 'wi_settings[nav_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			var navLocation = wp.customize.value( 'wi_settings[nav_position_setting]' )();
			...
			if ( $( 'body' ).hasClass( 'sticky-enabled' ) ) {
				...
				if ( 'fluid-nav' == newval ) {
					...
					if ( 'full-width' !== wp.customize.value( 'wi_settings[nav_inner_width]' )() ) {
						$( '.main-navigation .inside-navigation' ).addClass( 'grid-container' ).addClass( 'grid-parent' );
					}
				}
				if ( 'contained-nav' == newval ) {
					if ( ! mainNavigation.hasClass( 'has-branding' ) && witheme_live_preview.isFlex && ( 'nav-float-right' === navLocation || 'nav-float-left' === navLocation ) ) {
						return;
					}
	 ...
	 */
	wp.customize( 'wi_settings[nav_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
	 ...
	 */
	wp.customize( 'wi_settings[nav_alignment_setting]', function( value ) {
		value.bind( function( newval ) {
			var classes = [ 'left', 'center', 'right' ];
			var selector = 'body';
			var prefix = 'nav-aligned-';

			if ( witheme_live_preview.isFlex ) {
			...
			if ( witheme_live_preview.isFlex && witheme_live_preview.isRTL ) {
				jQuery( selector ).addClass( prefix + newval );
	 ...
	 * Footer width
	 */
	wp.customize( 'wi_settings[footer_layout_setting]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Inner footer width
	 */
	wp.customize( 'wi_settings[footer_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
	 ...
	 */
	witheme_classes_live_update( 'footer_bar_alignment', [ 'left', 'center', 'right' ], '.site-footer', 'footer-bar-align-' );

	jQuery( 'body' ).on( 'wi_spacing_updated', function() {
		var containerAlignment = wp.customize( 'wi_settings[container_alignment]' ).get(),
			containerWidth = wp.customize( 'wi_settings[container_width]' ).get(),
			containerLayout = wp.customize( 'wi_settings[content_layout_setting]' ).get(),
			contentLeft = witheme_live_preview.contentLeft,
			contentRight = witheme_live_preview.contentRight;

		if ( ! witheme_live_preview.isFlex && 'text' === containerAlignment ) {
			if ( typeof wp.customize( 'wi_spacing_settings[content_left]' ) !== 'undefined' ) {
				contentLeft = wp.customize( 'wi_spacing_settings[content_left]' ).get();
			}

			if ( typeof wp.customize( 'wi_spacing_settings[content_right]' ) !== 'undefined' ) {
				contentRight = wp.customize( 'wi_spacing_settings[content_right]' ).get();
			}
		...
		if ( witheme_live_preview.isFlex && 'boxes' === containerAlignment ) {
			...
			if ( typeof wp.customize( 'wi_spacing_settings[top_bar_left]' ) !== 'undefined' ) {
				topBarPaddingLeft = wp.customize( 'wi_spacing_settings[top_bar_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[top_bar_right]' ) !== 'undefined' ) {
				topBarPaddingRight = wp.customize( 'wi_spacing_settings[top_bar_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[header_left]' ) !== 'undefined' ) {
				headerPaddingLeft = wp.customize( 'wi_spacing_settings[header_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[header_right]' ) !== 'undefined' ) {
				headerPaddingRight = wp.customize( 'wi_spacing_settings[header_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[footer_widget_container_left]' ) !== 'undefined' ) {
				footerWidgetPaddingLeft = wp.customize( 'wi_spacing_settings[footer_widget_container_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[footer_widget_container_right]' ) !== 'undefined' ) {
				footerWidgetPaddingRight = wp.customize( 'wi_spacing_settings[footer_widget_container_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[footer_left]' ) !== 'undefined' ) {
				footerBarPaddingLeft = wp.customize( 'wi_spacing_settings[footer_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[footer_right]' ) !== 'undefined' ) {
				footerBarPaddingRight = wp.customize( 'wi_spacing_settings[footer_right]' ).get() + 'px';
			}
		...
		if ( witheme_live_preview.isFlex && 'text' === containerAlignment ) {
			...
			if ( typeof wp.customize( 'wi_spacing_settings[menu_item]' ) !== 'undefined' ) {
				menuItemPadding = wp.customize( 'wi_spacing_settings[menu_item]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'wi_spacing_settings[secondary_menu_item]' ) !== 'undefined' ) {
				secondaryMenuItemPadding = wp.customize( 'wi_spacing_settings[secondary_menu_item]' ).get() + 'px';
			}
	...
	wp.customize( 'wi_settings[global_colors]', function( value ) {
		value.bind( function( newval ) {
			var globalColors = '';
