...
class witheme_HTML_Attributes {
	...
	public function __construct() {
		add_filter( 'wi_parse_attr', array( $this, 'parse_attributes' ), 10, 3 );
	}
	...
	public function top_bar( $attributes ) {
		$classes = wi_get_element_classes( 'top_bar' );
	...
	public function inside_top_bar( $attributes ) {
		...
		if ( 'contained' === wi_get_option( 'top_bar_inner_width' ) ) {
	...
	public function site_header( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Site', 'witheme' );
	...
	public function inside_site_header( $attributes ) {
		$classes = wi_get_element_classes( 'inside_header' );
	...
	public function primary_navigation( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Primary', 'witheme' );
	...
	public function primary_inner_navigation( $attributes ) {
		$classes = wi_get_element_classes( 'inside_navigation' );
	...
	public function mobile_menu_control_wrapper( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Mobile Toggle', 'witheme' );
	...
	public function page_header( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Page', 'witheme' );
	...
	public function post_navigation( $attributes ) {
		if ( is_single() ) {
			...
			$attributes['aria-label'] = esc_attr__( 'Posts', 'witheme' );
		} else {
			$attributes['class'] .= ' paging-navigation';
			$attributes['aria-label'] = esc_attr__( 'Archive Page', 'witheme' );
		}
	...
	public function left_sidebar( $attributes ) {
		$classes = wi_get_element_classes( 'left_sidebar' );
	...
	public function right_sidebar( $attributes ) {
		$classes = wi_get_element_classes( 'right_sidebar' );
	...
	public function footer_widgets_container( $attributes ) {
		$classes = wi_get_element_classes( 'inside_footer' );
	...
	public function comment_meta( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Comment meta', 'witheme' );
	...
	public function footer_entry_meta( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Entry meta', 'witheme' );
...
witheme_HTML_Attributes::get_instance();
